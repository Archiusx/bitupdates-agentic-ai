...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        # On Vercel serverless, startup errors crash the function.
        # Log the error but allow the app to start; get_collection() will lazy-connect.
        log.warning("MongoDB connect at startup failed (will retry lazily)", error=str(e))
    log.info("✅ BIT Updates v2 ready")
    yield
