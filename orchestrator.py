...
# Lazy global orchestrator instance — avoids heavy init at module import time (Vercel cold start)
...
class _OrchestratorProxy:
    """Proxy that lazily initializes the real OrchestratorAgent on first access."""
