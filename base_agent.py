...
# Gemini is configured lazily inside BaseAgent.__init__ to avoid import-time crashes
# when GEMINI_API_KEY is not yet available (e.g. Vercel cold start before env vars are loaded).
...
class BaseAgent(ABC):
    ...
    def __init__(self, name: str, description: str):
        ...
        # Configure Gemini here (not at module import time) so env vars are loaded first
